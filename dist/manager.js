import React17, { createContext, lazy, useState, useCallback, Component, cloneElement, useEffect, Children, useContext, useRef, useMemo, useLayoutEffect } from 'react';
...
// node_modules/.pnpm/@storybook+blocks@8.0.1_@types+react@18.2.67_react-dom@18.2.0_react@18.2.0/node_modules/@storybook/blocks/dist/chunk-GWAJ4KRU.mjs
  ...
  "node_modules/.pnpm/react-colorful@5.6.1_react-dom@18.2.0_react@18.2.0/node_modules/react-colorful/dist/index.mjs"() {
    ...
    m = React17.memo(function(o2) {
      ...
      return useEffect(function() {
        return H4;
      }, [H4]), React17.createElement("div", u2({}, s2, { onTouchStart: C3, onMouseDown: C3, className: "react-colorful__interactive", ref: m2, onKeyDown: E3, tabIndex: 0, role: "slider" }));
    });
    g = function(e2) {
    ...
    p2 = function(r3) {
      ...
      return React17.createElement("div", { className: l2, style: { top: 100 * a2 + "%", left: 100 * n2 + "%" } }, React17.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t3 } }));
    };
    b = function(e2, r3, t3) {
    ...
    S2 = React17.memo(function(r3) {
      var t3 = r3.hue, n2 = r3.onChange, o2 = g(["react-colorful__hue", r3.className]);
      return React17.createElement("div", { className: o2 }, React17.createElement(m, { onMove: function(e2) {
        n2({ h: 360 * e2.left });
      }, onKey: function(e2) {
        n2({ h: s(t3 + 360 * e2.left, 0, 360) });
      }, "aria-label": "Hue", "aria-valuenow": b(t3), "aria-valuemax": "360", "aria-valuemin": "0" }, React17.createElement(p2, { className: "react-colorful__hue-pointer", left: t3 / 360, color: q({ h: t3, s: 100, v: 100, a: 1 }) })));
    });
    T = React17.memo(function(r3) {
      var t3 = r3.hsva, n2 = r3.onChange, o2 = { backgroundColor: q({ h: t3.h, s: 100, v: 100, a: 1 }) };
      return React17.createElement("div", { className: "react-colorful__saturation", style: o2 }, React17.createElement(m, { onMove: function(e2) {
        n2({ s: 100 * e2.left, v: 100 - 100 * e2.top });
      }, onKey: function(e2) {
        n2({ s: s(t3.s + 100 * e2.left, 0, 100), v: s(t3.v - 100 * e2.top, 0, 100) });
      }, "aria-label": "Color", "aria-valuetext": "Saturation " + b(t3.s) + "%, Brightness " + b(t3.v) + "%" }, React17.createElement(p2, { className: "react-colorful__saturation-pointer", top: 1 - t3.v / 100, left: t3.s / 100, color: q(t3) })));
    });
    F2 = function(e2, r3) {
      if (e2 === r3)
        return true;
    ...
    U = function(t3) {
      ...
      return React17.createElement("div", u2({}, s2, { ref: f3, className: m2 }), React17.createElement(T, { hsva: d3, onChange: h3 }), React17.createElement(S2, { hue: d3.h, onChange: h3, className: "react-colorful__last-control" }));
    };
    W = { defaultColor: "000", toHsva: x2, fromHsva: function(e2) {
      return w2({ h: e2.h, s: e2.s, v: e2.v, a: 1 });
    }, equal: X };
    Z = function(r3) {
      return React17.createElement(U, u2({}, r3, { colorModel: W }));
    };
    ee = function(r3) {
      ...
      return React17.createElement("div", { className: l2 }, React17.createElement("div", { className: "react-colorful__alpha-gradient", style: a2 }), React17.createElement(m, { onMove: function(e2) {
        o2({ a: e2.left });
      }, onKey: function(e2) {
        o2({ a: s(n2.a + e2.left) });
      }, "aria-label": "Alpha", "aria-valuetext": u3 + "%", "aria-valuenow": u3, "aria-valuemin": "0", "aria-valuemax": "100" }, React17.createElement(p2, { className: "react-colorful__alpha-pointer", left: n2.a, color: k(n2) })));
    };
    re = function(t3) {
      var n2 = t3.className, o2 = t3.colorModel, a2 = t3.color, l2 = void 0 === a2 ? o2.defaultColor : a2, i3 = t3.onChange, s2 = c2(t3, ["className", "colorModel", "color", "onChange"]), f3 = useRef(null);
      Q(f3);
      var v4 = Y(o2, l2, i3), d3 = v4[0], h3 = v4[1], m2 = g(["react-colorful", n2]);
      return React17.createElement("div", u2({}, s2, { ref: f3, className: m2 }), React17.createElement(T, { hsva: d3, onChange: h3 }), React17.createElement(S2, { hue: d3.h, onChange: h3 }), React17.createElement(ee, { hsva: d3, onChange: h3, className: "react-colorful__last-control" }));
    };
    le = { defaultColor: "hsla(0, 0%, 0%, 1)", toHsva: H, fromHsva: k, equal: P };
    ue = function(r3) {
      return React17.createElement(re, u2({}, r3, { colorModel: le }));
    };
    ...
    He = function(r3) {
      return React17.createElement(re, u2({}, r3, { colorModel: Ee }));
    };
  }
});
...
// node_modules/.pnpm/@storybook+blocks@8.0.1_@types+react@18.2.67_react-dom@18.2.0_react@18.2.0/node_modules/@storybook/blocks/dist/Color-RQJUDNI5.mjs
...
var init_Color_RQJUDNI5 = __esm({
  "node_modules/.pnpm/@storybook+blocks@8.0.1_@types+react@18.2.67_react-dom@18.2.0_react@18.2.0/node_modules/@storybook/blocks/dist/Color-RQJUDNI5.mjs"() {
    ...
    Swatch = ({ value: value3, active, onClick, style, ...props }) => {
      ...
      return React17.createElement(SwatchColor, { ...props, active, onClick, style: { ...style, backgroundImage } });
    };
    ...
    ColorControl = ({ name: name2, value: initialValue, onChange, onFocus, onBlur, presetColors, startOpen = false }) => {
      ...
      return React17.createElement(Wrapper, null, React17.createElement(PickerTooltip, { startOpen, closeOnOutsideClick: true, onVisibleChange: () => addPreset(color), tooltip: React17.createElement(TooltipContent, null, React17.createElement(Picker, { color: realValue === "transparent" ? "#000000" : realValue, onChange: updateValue, onFocus, onBlur }), presets.length > 0 && React17.createElement(Swatches, null, presets.map((preset, index) => React17.createElement(WithTooltip, { key: `${preset.value}-${index}`, hasChrome: false, tooltip: React17.createElement(Note, { note: preset.keyword || preset.value }) }, React17.createElement(Swatch, { value: preset[colorSpace], active: color && id(preset[colorSpace]) === id(color[colorSpace]), onClick: () => updateValue(preset.value) }))))) }, React17.createElement(Swatch, { value: realValue, style: { margin: 4 } })), React17.createElement(Input, { id: getControlId(name2), value: value3, onChange: (e2) => updateValue(e2.target.value), onFocus: (e2) => e2.target.select(), placeholder: "Choose color..." }), value3 ? React17.createElement(ToggleIcon, { onClick: cycleColorSpace }) : null);
    };
...
// node_modules/.pnpm/@storybook+blocks@8.0.1_@types+react@18.2.67_react-dom@18.2.0_react@18.2.0/node_modules/@storybook/blocks/dist/index.mjs
init_chunk_GWAJ4KRU();
...
// node_modules/.pnpm/@babel+runtime@7.24.0/node_modules/@babel/runtime/helpers/esm/inheritsLoose.js
...
// node_modules/.pnpm/@babel+runtime@7.24.0/node_modules/@babel/runtime/helpers/esm/getPrototypeOf.js
...
// node_modules/.pnpm/@babel+runtime@7.24.0/node_modules/@babel/runtime/helpers/esm/isNativeFunction.js
...
// node_modules/.pnpm/@babel+runtime@7.24.0/node_modules/@babel/runtime/helpers/esm/isNativeReflectConstruct.js
...
// node_modules/.pnpm/@babel+runtime@7.24.0/node_modules/@babel/runtime/helpers/esm/construct.js
...
// node_modules/.pnpm/@babel+runtime@7.24.0/node_modules/@babel/runtime/helpers/esm/wrapNativeSuper.js
...
var EmptyBlock = (props) => React17.createElement(Wrapper2, { ...props, className: "docblock-emptyblock sb-unstyled" });
...
var SourceSkeleton = () => React17.createElement(SourceSkeletonWrapper, null, React17.createElement(SourceSkeletonPlaceholder, null), React17.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }), React17.createElement(SourceSkeletonPlaceholder, { style: { width: "30%" } }), React17.createElement(SourceSkeletonPlaceholder, { style: { width: "80%" } }));
var Source = ({ isLoading, error, language, code, dark, format: format2, ...rest }) => {
  let { typography } = useTheme();
  if (isLoading)
    return React17.createElement(SourceSkeleton, null);
  if (error)
    return React17.createElement(EmptyBlock, null, error);
  let syntaxHighlighter = React17.createElement(StyledSyntaxHighlighter, { bordered: true, copyable: true, format: format2, language, className: "docblock-source sb-unstyled", ...rest }, code);
  if (typeof dark > "u")
    return syntaxHighlighter;
  let overrideTheme = dark ? themes.dark : themes.light;
  return React17.createElement(ThemeProvider, { theme: convert({ ...overrideTheme, fontCode: typography.fonts.mono, fontBase: typography.fonts.base }) }, syntaxHighlighter);
};
...
var Toolbar = ({ isLoading, storyId, baseUrl, zoom, resetZoom, ...rest }) => React17.createElement(Bar, { ...rest }, React17.createElement(Wrapper22, { key: "left" }, isLoading ? [1, 2, 3].map((key2) => React17.createElement(IconPlaceholder, { key: key2 })) : React17.createElement(React17.Fragment, null, React17.createElement(IconButton, { key: "zoomin", onClick: (e2) => {
  e2.preventDefault(), zoom(0.8);
}, title: "Zoom in" }, React17.createElement(ZoomIcon, null)), React17.createElement(IconButton, { key: "zoomout", onClick: (e2) => {
  e2.preventDefault(), zoom(1.25);
}, title: "Zoom out" }, React17.createElement(ZoomOutIcon, null)), React17.createElement(IconButton, { key: "zoomreset", onClick: (e2) => {
  e2.preventDefault(), resetZoom();
}, title: "Reset zoom" }, React17.createElement(ZoomResetIcon, null)))));
...
var getSource = (withSource, expanded, setExpanded) => {
  switch (true) {
    ...
    case expanded:
      return { source: React17.createElement(StyledSource, { ...withSource, dark: true }), actionItem: { title: "Hide code", className: "docblock-code-toggle docblock-code-toggle--expanded", onClick: () => setExpanded(false) } };
    default:
      return { source: React17.createElement(StyledSource, { ...withSource, dark: true }), actionItem: { title: "Show code", className: "docblock-code-toggle", onClick: () => setExpanded(true) } };
  }
};
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  ...
  return React17.createElement(PreviewContainer, { withSource, withToolbar, ...props, className: previewClasses.join(" ") }, withToolbar && React17.createElement(PositionedToolbar, { isLoading, border: true, zoom: (z3) => setScale(scale * z3), resetZoom: () => setScale(1), storyId: getStoryId(children), baseUrl: "./iframe.html" }), React17.createElement(ZoomContext.Provider, { value: { scale } }, React17.createElement(Relative, { className: "docs-story", onCopyCapture: withSource && onCopyCapture }, React17.createElement(ChildrenContainer, { isColumn: isColumn || !Array.isArray(children), columns, layout }, React17.createElement(Zoom.Element, { scale }, Array.isArray(children) ? children.map((child, i3) => React17.createElement("div", { key: i3 }, child)) : React17.createElement("div", null, children))), React17.createElement(ActionBar, { actionItems }))), withSource && expanded && source2);
};
...
var JsonAddValue = class extends Component {
  ...
  render() {
    ...
    return React17.createElement("span", { className: "rejt-add-value-node" }, inputElementKeyLayout, inputElementValueLayout, cancelButtonElementLayout, addButtonElementLayout);
  }
};
JsonAddValue.defaultProps = { onlyValue: false, addButtonElement: React17.createElement("button", null, "+"), cancelButtonElement: React17.createElement("button", null, "c") };
var JsonArray = class extends Component {
  ...
  renderCollapsed() {
    ...
    return React17.createElement("span", { className: "rejt-collapsed" }, React17.createElement("span", { className: "rejt-collapsed-text", style: collapsed, onClick: this.handleCollapseMode }, "[...] ", data.length, " ", data.length === 1 ? "item" : "items"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    ...
    return React17.createElement("span", { className: "rejt-not-collapsed" }, React17.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, "["), !addFormVisible && addItemButton, React17.createElement("ul", { className: "rejt-not-collapsed-list", style: ul }, data.map((item, index) => React17.createElement(JsonNode, { key: index, name: index.toString(), data: item, keyPath, deep: nextDeep, isCollapsed, handleRemove: this.handleRemoveItem(index), handleUpdateValue: this.handleEditValue, onUpdate: this.onChildUpdate, onDeltaUpdate, readOnly, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser }))), !isReadOnly && addFormVisible && React17.createElement("div", { className: "rejt-add-form", style: addForm }, React17.createElement(JsonAddValue, { handleAdd: this.handleAddValueAdd, handleCancel: this.handleAddValueCancel, onlyValue: true, addButtonElement, cancelButtonElement, inputElementGenerator, keyPath, deep, onSubmitValueParser })), React17.createElement("span", { className: "rejt-not-collapsed-delimiter", style: delimiter }, "]"), !isReadOnly && removeItemButton);
  }
  render() {
    ...
    return React17.createElement("div", { className: "rejt-array-node" }, React17.createElement("span", { onClick: this.handleCollapseMode }, React17.createElement("span", { className: "rejt-name", style: style.name }, name2, " :", " ")), value22);
  }
};
JsonArray.defaultProps = { keyPath: [], deep: 0, minusMenuElement: React17.createElement("span", null, " - "), plusMenuElement: React17.createElement("span", null, " + ") };
var JsonFunctionValue = class extends Component {
  ...
  render() {
    ...
    if (editEnabled && !resultOnlyResult) {
      ...
      result2 = React17.createElement("span", { className: "rejt-edit-form", style: style.editForm }, textareaElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout), minusElement = null;
    } else {
      result2 = React17.createElement("span", { className: "rejt-value", style: style.value, onClick: resultOnlyResult ? null : this.handleEditMode }, value22);
    ...
    return React17.createElement("li", { className: "rejt-function-value-node", style: style.li }, React17.createElement("span", { className: "rejt-name", style: style.name }, name2, " :", " "), result2, minusElement);
  }
};
JsonFunctionValue.defaultProps = { keyPath: [], deep: 0, handleUpdateValue: () => {
}, editButtonElement: React17.createElement("button", null, "e"), cancelButtonElement: React17.createElement("button", null, "c"), minusMenuElement: React17.createElement("span", null, " - ") };
var JsonNode = class extends Component {
  ...
  render() {
    ...
    switch (dataType) {
      case ERROR:
        return React17.createElement(JsonObject, { data, name: name2, isCollapsed, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate, readOnly: readOnlyTrue, dataType, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser });
      case OBJECT:
        return React17.createElement(JsonObject, { data, name: name2, isCollapsed, keyPath, deep, handleRemove, onUpdate, onDeltaUpdate, readOnly, dataType, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser });
      case ARRAY:
      ...
      case STRING:
        return React17.createElement(JsonValue, { name: name2, value: `"${data}"`, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case NUMBER:
        return React17.createElement(JsonValue, { name: name2, value: data, originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case BOOLEAN:
        return React17.createElement(JsonValue, { name: name2, value: data ? "true" : "false", originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case DATE:
        return React17.createElement(JsonValue, { name: name2, value: data.toISOString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly: readOnlyTrue, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case NULL:
        return React17.createElement(JsonValue, { name: name2, value: "null", originalValue: "null", keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case UNDEFINED:
        return React17.createElement(JsonValue, { name: name2, value: "undefined", originalValue: "undefined", keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case FUNCTION:
        return React17.createElement(JsonFunctionValue, { name: name2, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly, dataType, getStyle, cancelButtonElement, editButtonElement, textareaElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      case SYMBOL:
        return React17.createElement(JsonValue, { name: name2, value: data.toString(), originalValue: data, keyPath, deep, handleRemove, handleUpdateValue, readOnly: readOnlyTrue, dataType, getStyle, cancelButtonElement, editButtonElement, inputElementGenerator, minusMenuElement, logger: logger4, onSubmitValueParser });
      default:
        return null;
    }
  }
...
var JsonObject = class extends Component {
  ...
  renderCollapsed() {
    ...
    return React17.createElement("span", { className: "rejt-collapsed" }, React17.createElement("span", { className: "rejt-collapsed-text", style: collapsed, onClick: this.handleCollapseMode }, "{...}", " ", keyList.length, " ", keyList.length === 1 ? "key" : "keys"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name: name2, data, keyPath, deep, nextDeep, addFormVisible } = this.state, { isCollapsed, handleRemove, onDeltaUpdate, readOnly, getStyle, dataType, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser } = this.props, { minus, plus, addForm, ul, delimiter } = getStyle(name2, data, keyPath, deep, dataType), keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name2, data, keyPath, deep, dataType), addItemButton = cloneElement(plusMenuElement, { onClick: this.handleAddMode, className: "rejt-plus-menu", style: plus }), removeItemButton = cloneElement(minusMenuElement, { onClick: handleRemove, className: "rejt-minus-menu", style: minus }), list = keyList.map((key2) => React17.createElement(JsonNode, { key: key2, name: key2, data: data[key2], keyPath, deep: nextDeep, isCollapsed, handleRemove: this.handleRemoveValue(key2), handleUpdateValue: this.handleEditValue, onUpdate: this.onChildUpdate, onDeltaUpdate, readOnly, getStyle, addButtonElement, cancelButtonElement, editButtonElement, inputElementGenerator, textareaElementGenerator, minusMenuElement, plusMenuElement, beforeRemoveAction, beforeAddAction, beforeUpdateAction, logger: logger4, onSubmitValueParser }));
  ...
  render() {
    ...
    return React17.createElement("div", { className: "rejt-object-node" }, React17.createElement("span", { onClick: this.handleCollapseMode }, React17.createElement("span", { className: "rejt-name", style: style.name }, name2, " :", " ")), value22);
  }
};
JsonObject.defaultProps = { keyPath: [], deep: 0, minusMenuElement: React17.createElement("span", null, " - "), plusMenuElement: React17.createElement("span", null, " + ") };
var JsonValue = class extends Component {
  ...
  render() {
    ...
    return React17.createElement("li", { className: "rejt-value-node", style: style.li }, React17.createElement("span", { className: "rejt-name", style: style.name }, name2, " : "), isEditing ? React17.createElement("span", { className: "rejt-edit-form", style: style.editForm }, inputElementLayout, " ", cancelButtonElementLayout, editButtonElementLayout) : React17.createElement("span", { className: "rejt-value", style: style.value, onClick: isReadOnly ? null : this.handleEditMode }, String(value22)), !isReadOnly && !isEditing && minusMenuLayout);
  }
};
JsonValue.defaultProps = { keyPath: [], deep: 0, handleUpdateValue: () => Promise.resolve(), editButtonElement: React17.createElement("button", null, "e"), cancelButtonElement: React17.createElement("button", null, "c"), minusMenuElement: React17.createElement("span", null, " - ") };
...
} }, onSubmitValueParser: (isEditMode, keyPath, deep, name2, rawValue) => parse3(rawValue), inputElement: () => React17.createElement("input", null), textareaElement: () => React17.createElement("textarea", null), fallback: null };
...
var ObjectControl = ({ name: name2, value: value22, onChange }) => {
  ...
  if (useEffect(() => {
    ...
    return React17.createElement(Button, { id: getControlSetterButtonId(name2), onClick: onForceVisible }, "Set object");
  let rawJSONForm = React17.createElement(RawInput, { ref: htmlElRef, id: getControlId(name2), name: name2, defaultValue: value22 === null ? "" : JSON.stringify(value22, null, 2), onBlur: (event) => updateRaw(event.target.value), placeholder: "Edit JSON string...", autoFocus: forceVisible, valid: parseError ? "error" : null }), isObjectOrArray = Array.isArray(value22) || typeof value22 == "object" && value22?.constructor === Object;
  return React17.createElement(Wrapper6, null, isObjectOrArray && React17.createElement(RawButton, { onClick: (e2) => {
    e2.preventDefault(), setShowRaw((v4) => !v4);
  } }, showRaw ? React17.createElement(EyeCloseIcon, null) : React17.createElement(EyeIcon, null), React17.createElement("span", null, "RAW")), showRaw ? rawJSONForm : React17.createElement(JsonTree, { readOnly: !isObjectOrArray, isCollapsed: isObjectOrArray ? void 0 : () => true, data, rootName: name2, onFullyUpdate: onChange, getStyle: getCustomStyleFunction(theme), cancelButtonElement: React17.createElement(ButtonInline, { type: "button" }, "Cancel"), editButtonElement: React17.createElement(ButtonInline, { type: "submit" }, "Save"), addButtonElement: React17.createElement(ButtonInline, { type: "submit", primary: true }, "Save"), plusMenuElement: React17.createElement(ActionAddIcon, null), minusMenuElement: React17.createElement(ActionSubstractIcon, null), inputElement: (_2, __, ___, key2) => key2 ? React17.createElement(Input2, { onFocus: selectValue, onBlur: dispatchEnterKey }) : React17.createElement(Input2, null), fallback: rawJSONForm }));
};
...
var RangeControl = ({ name: name2, value: value22, onChange, min = 0, max = 100, step = 1, onBlur, onFocus }) => {
  ...
  return React17.createElement(RangeWrapper, null, React17.createElement(RangeLabel, null, min), React17.createElement(RangeInput, { id: getControlId(name2), type: "range", onChange: handleChange, name: name2, value: value22, min, max, step, onFocus, onBlur }), React17.createElement(RangeCurrentAndMaxLabel, { numberOFDecimalsPlaces, max }, hasValue ? value22.toFixed(numberOFDecimalsPlaces) : "--", " / ", max));
};
styled.label({ display: "flex" });
...
styled.div({ display: "flex", flexDirection: "column", gap: 4, maxWidth: 415 });
styled.div(({ theme }) => ({ fontWeight: theme.typography.weight.bold, fontSize: theme.typography.size.s2 - 1, textAlign: "center", color: theme.textColor }));
styled.div(({ theme }) => ({ fontWeight: theme.typography.weight.regular, fontSize: theme.typography.size.s2 - 1, textAlign: "center", color: theme.textMutedColor }));
...
styled(IconButton)(({ theme }) => ({ color: theme.barTextColor, margin: "-4px -12px -4px 0" }));
...
var HeaderWithOcticonAnchor = ({ as, id: id2, children, ...rest }) => {
  ...
  return React17.createElement(OcticonHeader, { id: id2, ...rest }, React17.createElement(OcticonAnchor, { "aria-hidden": "true", href: hash, tabIndex: -1, target: "_self", onClick: (event) => {
    document2.getElementById(id2) && navigate(context, hash);
  } }, React17.createElement(LinkIcon, null)), children);
};
var HeaderMdx = (props) => {
  let { as, id: id2, children, ...rest } = props;
  if (id2)
    return React17.createElement(HeaderWithOcticonAnchor, { as, id: id2, ...rest }, children);
  let Component4 = as, { as: omittedAs, ...withoutAs } = props;
  return React17.createElement(Component4, { ...nameSpaceClassNames(withoutAs, as) });
};
SUPPORTED_MDX_HEADERS.reduce((acc, headerType) => ({ ...acc, [headerType]: (props) => React17.createElement(HeaderMdx, { as: headerType, ...props }) }), {});
...
var Heading2 = ({ children, disableAnchor, ...props }) => {
  ...
  return React17.createElement(HeaderMdx, { as: "h2", id: tagID, ...props }, children);
};
